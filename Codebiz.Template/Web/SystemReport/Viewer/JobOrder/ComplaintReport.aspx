...
<%--<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComplaintReport.aspx.cs" Inherits="Web.SystemReport" %>--%>
    ...
    <script runat="server">
        void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                int? statusId = int.Parse(Server.UrlDecode(Request.QueryString["statusId"]));
                int appUserId = int.Parse(Server.UrlDecode(Request.QueryString["appUserId"]));

                var getData = _reportService.GenerateComplaintReportList(dateFrom, dateTo.AddDays(1), statusId);
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/SystemReport/RDLC/JobOrder/ComplaintReport.rdlc");
                ReportViewer1.LocalReport.DataSources.Clear();
                ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("ComplaintReportDataSet", getData));
    ...
    <div id="report-container">
           <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
            ...
            <rsweb:ReportViewer AsyncRendering="False" SizeToReportContent="True" ID="ReportViewer1" runat="server" PageCountMode="Actual" 
                ...
                <LocalReport ReportPath="SystemReport\CSA\RDLC\ComplaintReport.rdlc">
                </LocalReport>
