        ...
        <script runat="server">
            void Page_Load(object sender, EventArgs e)
            {
                if (!Page.IsPostBack)
                {
                    ...
                    var transformerRentalService = System.Web.Mvc.DependencyResolver.Current.GetService(typeof(ITransformerRentalService)) as ITransformerRentalService;
                    ...
                    var getData=transformerRentalService.GetDetailsForContract(id);
                    ...
                    var generalmanagersignatureImg = _contentFileService.GetCurrentCroppedEmployeeSignatureById(generalManger != null ? generalManger.AppUserId : 0);
                    ...
                    getData[0].GeneralManagerFullName = generalManger != null ? generalManger.FullName.ToUpper() : "";
                    ...
                    getData[0].OfficeAddress = currentUserService.GetById(appuserId)?.CurrentOffice;
                    ReportViewer1.ProcessingMode = ProcessingMode.Local;
                    ReportViewer1.LocalReport.EnableExternalImages = true;
                    ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/SystemReport/RDLC/CustomerService/TransformerRentalContract.rdlc");
                    ReportViewer1.LocalReport.DataSources.Clear();
                    ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("TransformerRentalContract", getData));
                    ReportViewer1.LocalReport.EnableHyperlinks = true;
                    ReportViewer1.LocalReport.DisplayName = $"TransformerRentalContract{DateTime.Now.ToString("yyyyMMddHHmmss")}";
    ...
    <div id="report-container">
           <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
            ...
            <rsweb:ReportViewer AsyncRendering="False" SizeToReportContent="True" ID="ReportViewer1" runat="server" PageCountMode="Actual" 
                ...
                <LocalReport ReportPath="SystemReport/CustomerService/RDLC/TransformerRentalContract.rdlc">
                </LocalReport>
