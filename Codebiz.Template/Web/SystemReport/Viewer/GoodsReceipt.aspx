    ...
    <title></title>
            <script runat="server">
                void Page_Load(object sender, EventArgs e)
                {
                    if (!Page.IsPostBack)
                    {
                        //int goodsReceiptId = int.Parse(Server.UrlDecode(Request.QueryString["goodsReceiptId"]));
                        string goodsReceiptCode  = Server.UrlDecode(Request.QueryString["goodsReceiptCode"]);
                        makePdf(goodsReceiptCode);
                    }
                }
                private void makePdf(string goodsReceiptCode)
                {
                    Response.Clear();
                     ...
                     var PdfFolder = _configSettingService.GetValueById((int)Codebiz.Domain.Common.Model.Enums.ConfigurationSettings.GoodsReceiptPdfPath);
                    // string filePath = "C:\\Users\\Donnel Imson\\Downloads\\GoodsReceipts\\"+goodsReceiptCode+".pdf";
                    string filePath = PdfFolder+goodsReceiptCode+".pdf";
