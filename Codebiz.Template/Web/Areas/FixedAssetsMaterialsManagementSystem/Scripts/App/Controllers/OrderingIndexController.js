...
angular.module("MetronicApp")
    ...
    .controller('OrderingIndexController', ['$scope', '$q', 'OrderingService', 'NgTableParams', '$uibModal',
            function ($scope, $q, OrderingService, NgTableParams, $uibModal ) {
                //Table Initialize 
                $scope.tableParamsOrder = new NgTableParams({}, { dataset: [] });
