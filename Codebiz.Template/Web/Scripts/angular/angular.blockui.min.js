...
angular.module("blockUI", ["templates-angularBlockUI"]), angular.module("blockUI").config(["$provide", "$httpProvider", function (a, b) {
    ...
    return function (c, d, e) {
        ...
        if (f.length) {
            ...
            if ("BODY" === f[0].tagName) var h = c.$on("$viewContentLoaded", function () {
                ...
                var i = e.blockUi ? e.blockUi : c.$id;
                g = a.instances.get(i);
    ...
    function e(b) {
        return c.autoBlock && (d(), f.stop()), a.reject(b)
    }
    var f;
    return {
        request: function (a) {
            return c.autoBlock && (c.requestFilter(a) === !1 ? a.$_noBlock = !0 : (d(), a.$_blocks = f.instances.locate(a), a.$_blocks.start())), a
        },
        requestError: e,
        response: function (a) {
            var b = a.config;
            return c.autoBlock && !b.$_noBlock && b.$_blocks && (d(), b.$_blocks.stop()), a
        },
        responseError: e
    }
    ...
    angular.module("angular-block-ui/angular-block-ui.tmpl.html", []).run(["$templateCache",
        function ($templateCache) {
            $templateCache.put("angular-block-ui/angular-block-ui.tmpl.html",
                ...
                "<img src=\"" + document.baseUrlNoArea + "img/loader.gif\" >" +
