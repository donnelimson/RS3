...
namespace Codebiz.Domain.ERP.Context.DbTrackerMigrations
{
    public class DbTrackerConfiguration : DbMigrationsConfiguration<DbTrackerContext>
    {
        ...
        private void CreateConfigSettings(DbTrackerContext context, DateTime now)
        {
            ...
            // Config Settings
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting { ConfigSettingId = (int)ConfigurationSettings.ConnectionString, Name = "ConnectionString", Description = "Database Connection", Value = "PnpPAIS", ConfigSettingDataTypeId = 2, ConfigSettingGroupId = 1, IsActive = true, CreatedOn = now, CreatedByAppUserId = AdminUser.AppUserId });
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting { ConfigSettingId = (int)ConfigurationSettings.SmtpDisplayName, Name = "SmtpDisplayName", Description = "SmtpDisplayName", Value = "noreply.tarelco1", ConfigSettingGroupId = 4, IsActive = true, ConfigSettingDataTypeId = 2, CreatedByAppUserId = AdminUser.AppUserId, CreatedOn = DateTime.Now });
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting { ConfigSettingId = (int)ConfigurationSettings.SmtpUsername, Name = "SmtpUsername", Description = "SmtpUsername", Value = "noreply.tarelco1@gmail.com", ConfigSettingGroupId = 4, IsActive = true, ConfigSettingDataTypeId = 2, CreatedByAppUserId = AdminUser.AppUserId, CreatedOn = DateTime.Now });
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting { ConfigSettingId = (int)ConfigurationSettings.SmtpPassword, Name = "SmtpPassword", Description = "SmtpPassword", Value = "Tarelco1_3m@il_S3nd3r", ConfigSettingGroupId = 4, IsActive = true, ConfigSettingDataTypeId = 2, CreatedByAppUserId = AdminUser.AppUserId, CreatedOn = DateTime.Now });
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting { ConfigSettingId = (int)ConfigurationSettings.SitePublicBaseUrl, Name = "SitePublicBaseUrl", Description = "Site Public BaseUrl", Value = @"http://dev.codebiz.com.ph/tarelco", ConfigSettingGroupId = 4, IsActive = true, ConfigSettingDataTypeId = 2, CreatedByAppUserId = AdminUser.AppUserId, CreatedOn = DateTime.Now });
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting { ConfigSettingId = (int)ConfigurationSettings.EmailAlertRecipients, Name = "EmailAlertRecipients", Description = "Email Alert Recipients", Value = @"paultapon@gmail.com", ConfigSettingGroupId = 4, IsActive = true, ConfigSettingDataTypeId = 2, CreatedByAppUserId = AdminUser.AppUserId, CreatedOn = DateTime.Now });
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ...
                Value = @"C:\Tarelco\EmployeePhotoFolder",
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.DefaultFolder,
                Name = ConfigurationSettings.DefaultFolder.ToString(),
                Description = ConfigurationSettings.DefaultFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\DefaultFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.MemberPhotoFolder,
                Name = ConfigurationSettings.MemberPhotoFolder.ToString(),
                Description = ConfigurationSettings.MemberPhotoFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\MemberPhotoFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Member Signature Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.MemberSignatureFolder,
                Name = ConfigurationSettings.MemberSignatureFolder.ToString(),
                Description = ConfigurationSettings.MemberSignatureFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\MemberSignatureFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Member Supporting Documents Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.MemberSupportingDocumentsFolder,
                Name = ConfigurationSettings.MemberSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.MemberSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\MemberSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Membership Barcode Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.MembershipBarcodeFolder,
                Name = ConfigurationSettings.MembershipBarcodeFolder.ToString(),
                Description = ConfigurationSettings.MembershipBarcodeFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\MembershipBarcodeFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Billing Address Pdf Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.BillingAddressPdfFolder,
                Name = ConfigurationSettings.BillingAddressPdfFolder.ToString(),
                Description = ConfigurationSettings.BillingAddressPdfFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\BillingAddressPdfFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Discount Application Supporting Documents Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.DiscountApplicationSupportingDocumentsFolder,
                Name = ConfigurationSettings.DiscountApplicationSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.DiscountApplicationSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\DiscountApplicationSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Burial Assistance Supporting Documents Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.BurialAssistanceSupportingDocumentsFolder,
                Name = ConfigurationSettings.BurialAssistanceSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.BurialAssistanceSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\BurialAssistanceSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.DisconnectionSupportingDocumentsFolder,
                Name = ConfigurationSettings.DisconnectionSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.DisconnectionSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\DisconnectionSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Change Of Name Supporting Documents Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.ChangeOfNameSupportingDocumentsFolder,
                Name = ConfigurationSettings.ChangeOfNameSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.ChangeOfNameSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\ChangeOfNameSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.ReconnectionSupportingDocumentsFolder,
                Name = ConfigurationSettings.ReconnectionSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.ReconnectionSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\ReconnectionSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            //Other Request Supporting Documents Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.OtherRequestSupportingDocumentsFolder,
                Name = ConfigurationSettings.OtherRequestSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.OtherRequestSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\OtherRequestSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Close and Transfer  Supporting Documents Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.CloseAndTransferSupportingDocumentsFolder,
                Name = ConfigurationSettings.CloseAndTransferSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.CloseAndTransferSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\CloseAndTransferSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Net Metering Documents Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.NetMeteringDocumentsFolder,
                Name = ConfigurationSettings.NetMeteringDocumentsFolder.ToString(),
                Description = ConfigurationSettings.NetMeteringDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\NetMeteringDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Job Order Complaint Supporting Documents Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.JobOrderComplaintSupportingDocumentsFolder,
                Name = ConfigurationSettings.JobOrderComplaintSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.JobOrderComplaintSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\JobOrderComplaintSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Job Order Request Supporting Documents Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.JobOrderRequestSupportingDocumentsFolder,
                Name = ConfigurationSettings.JobOrderRequestSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.JobOrderRequestSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\JobOrderRequestSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.ItemMasterDataAttachment,
                Name = ConfigurationSettings.ItemMasterDataAttachment.ToString(),
                Description = ConfigurationSettings.ItemMasterDataAttachment.GetEnumDescription(),
                Value = @"C:\Tarelco\ItemMasterDataAttachment",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.BusinessPartnerSupportingDocumentsFolder,
                Name = ConfigurationSettings.BusinessPartnerSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.BusinessPartnerSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\BusinessPartnerSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.InventoryTransferSupportingDocumentsFolder,
                Name = ConfigurationSettings.InventoryTransferSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.InventoryTransferSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\InventoryTransferSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.CounterSetupDocumentsFolder,
                Name = ConfigurationSettings.CounterSetupDocumentsFolder.ToString(),
                Description = ConfigurationSettings.CounterSetupDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\CounterSetupSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // House Wiring Inspection Supporting Documents Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.HouseWiringInspectionSupportingDocumentsFolder,
                Name = ConfigurationSettings.HouseWiringInspectionSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.HouseWiringInspectionSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\HouseWiringInspectionSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Account Supporting Documents Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.AccountSupportingDocumentsFolder,
                Name = ConfigurationSettings.AccountSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.AccountSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\AccountSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Connection Order Pdf Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.ConnectionOrderPdfFolder,
                Name = ConfigurationSettings.ConnectionOrderPdfFolder.ToString(),
                Description = ConfigurationSettings.ConnectionOrderPdfFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\ConnectionOrderPdfFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.SalesInvoiceDataAttachment,
                Name = ConfigurationSettings.SalesInvoiceDataAttachment.ToString(),
                Description = ConfigurationSettings.SalesInvoiceDataAttachment.GetEnumDescription(),
                Value = @"C:\Tarelco\SalesInvoiceDataAttachment",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.SalesDeliveryDataAttachment,
                Name = ConfigurationSettings.SalesDeliveryDataAttachment.ToString(),
                Description = ConfigurationSettings.SalesDeliveryDataAttachment.GetEnumDescription(),
                Value = @"C:\Tarelco\SalesDeliveryDataAttachment",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.SalesQuotationDataAttachment,
                Name = ConfigurationSettings.SalesQuotationDataAttachment.ToString(),
                Description = ConfigurationSettings.SalesQuotationDataAttachment.GetEnumDescription(),
                Value = @"C:\Tarelco\ SalesQuotationDataAttachment",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.SalesOrderDataAttachment,
                Name = ConfigurationSettings.SalesOrderDataAttachment.ToString(),
                Description = ConfigurationSettings.SalesOrderDataAttachment.GetEnumDescription(),
                Value = @"C:\Tarelco\SalesOrderDataAttachment",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Material Charge Ticket Pdf Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.MaterialChargeTicketPdfFolder,
                Name = ConfigurationSettings.MaterialChargeTicketPdfFolder.ToString(),
                Description = ConfigurationSettings.MaterialChargeTicketPdfFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\MaterialChargeTicketPdfFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.JobOrderPdfFolder,
                Name = ConfigurationSettings.JobOrderPdfFolder.ToString(),
                Description = ConfigurationSettings.JobOrderPdfFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\JobOrderPdfFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Purchase Order Pdf Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.PurchaseOrderPdfFolder,
                Name = ConfigurationSettings.PurchaseOrderPdfFolder.ToString(),
                Description = ConfigurationSettings.PurchaseOrderPdfFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\PurchaseOrderPdfFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Goods Receipt Pdf Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.GoodsReceiptPdfFolder,
                Name = ConfigurationSettings.GoodsReceiptPdfFolder.ToString(),
                Description = ConfigurationSettings.GoodsReceiptPdfFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\GoodsReceiptPdfFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.GasSlipPdfFolder,
                Name = ConfigurationSettings.GasSlipPdfFolder.ToString(),
                Description = ConfigurationSettings.GasSlipPdfFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\GasSlipPdfFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.EmployeeSignatureFolder,
                Name = ConfigurationSettings.EmployeeSignatureFolder.ToString(),
                Description = ConfigurationSettings.EmployeeSignatureFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\EmployeeSignatureFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.InventoryReceivingSupportingDocumentsFolder,
                Name = ConfigurationSettings.InventoryReceivingSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.InventoryReceivingSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\InventoryReceivingSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.ProcessJobOrderDocumentsFolder,
                Name = ConfigurationSettings.ProcessJobOrderDocumentsFolder.ToString(),
                Description = ConfigurationSettings.ProcessJobOrderDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\ProcessJobOrderDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.OfficialReceiptsFolder,
                Name = ConfigurationSettings.OfficialReceiptsFolder.ToString(),
                Description = ConfigurationSettings.OfficialReceiptsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\OfficialReceiptsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.MaterialRequestSupportingDocumentsFolder,
                Name = ConfigurationSettings.MaterialRequestSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.MaterialRequestSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\MaterialRequestSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.MaterialRequestFolder,
                Name = ConfigurationSettings.MaterialRequestFolder.ToString(),
                Description = ConfigurationSettings.MaterialRequestFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\MaterialRequestFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            // Withdrawal Slip PDF Folder
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.WithdrawalSlipPDFFolder,
                Name = ConfigurationSettings.WithdrawalSlipPDFFolder.ToString(),
                Description = ConfigurationSettings.WithdrawalSlipPDFFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\WithdrawalSlipPDFFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.ContestableApplicationFolder,
                Name = ConfigurationSettings.ContestableApplicationFolder.ToString(),
                Description = ConfigurationSettings.ContestableApplicationFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\ContestableApplicationFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.RequisitionVoucherSupportingDocumentsFolder,
                Name = ConfigurationSettings.RequisitionVoucherSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.RequisitionVoucherSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\RequisitionVoucherSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.RequisitionVoucherFolder,
                Name = ConfigurationSettings.RequisitionVoucherFolder.ToString(),
                Description = ConfigurationSettings.RequisitionVoucherFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\RequisitionVoucherFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.TransformerRentalFolder,
                Name = ConfigurationSettings.TransformerRentalFolder.ToString(),
                Description = ConfigurationSettings.TransformerRentalFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\TransformerRentalFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.TransformerRentalWitnessSignatureFolder,
                Name = ConfigurationSettings.TransformerRentalWitnessSignatureFolder.ToString(),
                Description = ConfigurationSettings.TransformerRentalWitnessSignatureFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\TransformerRentalWitnessSignatureFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.ChangeOfMeterSupportingDocumentsFolder,
                Name = ConfigurationSettings.ChangeOfMeterSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.ChangeOfMeterSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\ChangeOfMeterSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.SpecialLightingSupportingDocumentsFolder,
                Name = ConfigurationSettings.SpecialLightingSupportingDocumentsFolder.ToString(),
                Description = ConfigurationSettings.SpecialLightingSupportingDocumentsFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\SpecialLightingSupportingDocumentsFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.BillingAdjustmentAttachmentFolder,
                Name = ConfigurationSettings.BillingAdjustmentAttachmentFolder.ToString(),
                Description = ConfigurationSettings.BillingAdjustmentAttachmentFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\BillingAdjustmentAttachmentFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.StatementOfAccountFolder,
                Name = ConfigurationSettings.StatementOfAccountFolder.ToString(),
                Description = ConfigurationSettings.StatementOfAccountFolder.GetEnumDescription(),
                Value = @"C:\Tarelco\StatementOfAccountFolder",
                ConfigSettingGroupId = 5,
                IsActive = true,
                ConfigSettingDataTypeId = 2,
                CreatedByAppUserId = AdminUser.AppUserId,
            ...
            context.ConfigSettings.AddOrUpdate(a => a.Name, new ConfigSetting
            {
                ConfigSettingId = (int)ConfigurationSettings.CoopVehicleSupportingDocumentsFolder,
